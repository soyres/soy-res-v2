...
export default function Running() {
  ...
  return (
    <PageContainer accentColor={accentColor}>
        ...
        description="Training for marathons and pushing physical boundaries. Every mile is a lesson in
                discipline, resilience, and the power of consistency. From early morning runs to
                race day victories, the journey continues."
        stats={[
            { label: 'Total Miles', value: '2,847' },
            { label: 'Marathons', value: '5' },
            { label: 'PR Time', value: '3:24:15' },
            { label: 'Miles This Month', value: '128mi' }
        ]}
        accentColor={accentColor}
        delay={0.2}
        />
